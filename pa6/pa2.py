...
def create_filter_bank(save_filter_image=False):
    ...
    gradfilter = np.asarray([1, -1])
    filter_bank = (
        ndimage.convolve1d(G2, gradfilter, 1),
        ndimage.convolve1d(G2, gradfilter, 0),
        ndimage.convolve1d(G4, gradfilter, 1),
        ndimage.convolve1d(G4, gradfilter, 0),
        ndimage.convolve1d(G8, gradfilter, 1),
        ndimage.convolve1d(G8, gradfilter, 0),
        G8 - G2,
        G4 - G2
    )
